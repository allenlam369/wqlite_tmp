...
echo.
echo Importing table RSTATION to PostgreSQL
...
rem --------------------------------------------------------------
:end
echo Finishing RSTATION table import with exit code %exit_code%
