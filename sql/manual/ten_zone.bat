...
echo.
echo Importing table TEN_ZONE to PostgreSQL
...
"C:\\Program Files\\PostgreSQL\\13\\bin\psql.exe" -h localhost -U postgres -p 5432 -d wqplis_lite --file ten_zone_ddl.sql >> ten_zone.log
...
"C:\\Program Files\\PostgreSQL\\13\\bin\psql.exe" -h localhost -U postgres -p 5432 -d wqplis_lite --file ten_zone.ldi
...
rem --------------------------------------------------------------
:end
echo Finishing TEN_ZONE table import with exit code %exit_code%
