...
echo.
echo Importing table WPCO_WCZ to PostgreSQL
...
rem --------------------------------------------------------------
:end
echo Finishing WPCO_WCZ table import with exit code %exit_code%
