...
/**
 * The persistent class for the marine_water1 database table.
 * 
 */
@Entity
@Table(name="marine_water1")
@NamedQuery(name="MarineWater1.findAll", query="SELECT m FROM MarineWater1 m")
public class MarineWater1 implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private MarineWater1PK id;
	...
	public MarineWater1PK getId() {
		return this.id;
	}

	public void setId(MarineWater1PK id) {
		this.id = id;
	}
