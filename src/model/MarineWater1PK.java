...
/**
 * The primary key class for the marine_water1 database table.
 * 
 */
@Embeddable
public class MarineWater1PK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MarineWater1PK)) {
			return false;
		}
		MarineWater1PK castOther = (MarineWater1PK)other;
		return 
